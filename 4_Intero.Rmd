...
- Higher HCT accuracy score associated with increased lie confidence and decreased truth confidence in polygraph condition only.
- Significant interaction in truth only.
...
- Higher HCT accuracy score associated with decreased lie heart rate in interrogation condition only.
- Significant interaction.
- Generally, larger effect in interrogation condition for heart rate?
- Plateau effect in polygraph condition for heart rate?
...
- Higher HCT confidence score associated with increased lie confidence and decreased truth confidence in both conditions, with larger effect in polygraph condition.
...
- Higher HCT confidence score associated with faster lie reaction time in polygraph condition and faster truth reaction time in both conditions.
...
- Higher HCT awareness score associated with decreased lie confidence in polygraph condition only.
- Significant interaction.
...
- Higher HCT awareness score associated with decreased lie heart rate in interrogation condition only.
- Significant interaction.
...
- Higher MAIA score associated with increased lie confidence in both conditions with a larger effect in polygraph condition, and decreased truth confidence in polygraph condition only.
- Significant interactions.
- Effect in lie driven by all domains except trusting and emotional awareness, effect in truth driven by noticing, attention regulation and self regulation domains.
...
#### RT
- Higher MAIA score associated with faster truth reaction time in polygraph condition only.
- Significant interaction.
- Driven by body listening, attention regulation and self regulation domains.
- Faster lie reaction time in polygraph condition for noticing, body listening and attention regulation domains.
...
- Effect only in trusting and emotional awareness domains: higher score associated with increased lie heart rate in interrogation for both, increased truth heart rate in interrogation for emotional awareness only.
...
p_conf_maia_total / 
  ...
  patchwork::plot_annotation(title = "Interoception (MAIA) 1/2", theme = theme(plot.title = element_text(hjust = 0.5)))
  
p_conf_maia_notworrying / 
  p_conf_maia_emotionalawareness / 
  p_conf_maia_attentionregulation / 
  p_conf_maia_selfregulation +
  patchwork::plot_annotation(title = "Interoception (MAIA) 2/2", theme = theme(plot.title = element_text(hjust = 0.5)))
