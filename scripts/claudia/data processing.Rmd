...
data <- mydata %>% 
  ...
  mutate(social_start = as.numeric(social_start)) %>% 
  mutate(social_stop = as.numeric(social_stop)) %>% 
  mutate(polyg_start = as.numeric(polyg_start)) %>% 
  mutate(polyg_stop = as.numeric(polyg_stop)) %>% 
  mutate(ID = as.numeric(ID)) %>%
