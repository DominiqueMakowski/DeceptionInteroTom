...
\includegraphics[width=1\linewidth]{../figures/figure1} \textbackslash caption\{Interindividual corrrelates of lying confidence. The lines shows the relationship (with 95\% CI uncertainty), assessed via Bayesian mixed models (\textbf{pd \textgreater{} 97\%, }pd \textgreater{} 99\%, ***pd \textgreater{} 99.9\%), between the participants' interoceptive and theory of mind composite scores and the confidence ratings of their lies and truthful asnwers. Their average lying confidence (+/- 1 SD), withing the two experimental conditions, is displayed as points for descriptive purposes (as the models were ran on individual trials).\}\label{fig:unnamed-chunk-1}
...
The material (stimuli generation code, experiment code, raw data, analysis script with complementary figures and analyses, etc.) for this research is available at \textbf{\url{https://github.com/DominiqueMakowski/DeceptionInteroTom}}.
