...
Given its multidimensional nature, the MAIA-2 [@mehling2012multidimensional], a 37-item questionnaire which measures 8 distinct facets of interoception including Noticing (e.g., *I notice when I am uncomfortable in my body*; $\alpha = 0.70$), Not-Distracting (e.g., *I try to ignore pain*; $\alpha = 0.87$), Not-Worrying (e.g., *I can stay calm and not worry when I have feelings of discomfort or pain*; $\alpha = 0.68$), Attention Regulation (e.g., *I can refocus my attention from thinking to sensing my body*; $\alpha = 0.85$), Emotional Awareness (e.g., *I notice how my body changes when I am angry*; $\alpha = 0.75$), Self-Regulation (e.g., *I can use my breath to reduce tension*; $\alpha = 0.62$), Body Listening (e.g., *I listen to information from my body about my emotional state*; $\alpha = 0.88$), and Trust (e.g., *I trust my body sensations*; $\alpha = 0.89$), using 5-point Likert scales, was also administered.
