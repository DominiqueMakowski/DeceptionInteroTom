...
A novel and computerized directed-lying experimental paradigm was designed to assess participants' lying ability in different scenarios. Each *Deception Task* trial is comprised of a question presented on a computer screen with an accompanying instruction that either asked participants to verbally lie or tell the truth. The instructions for each trial were displayed briefly, for a maximum of 10 seconds, or until the participants responded accordingly. Notably, these questions were either phrased directly (*"What is your favourite sport?*) or indirectly (*"Is your favourite sport Hockey?"*). The *Deception Task* paradigm consists of 2 conditions - namely, the *Interrogation Condition* and the *Polygraph Condition*.
